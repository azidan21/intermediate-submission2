...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewModel: MapsViewModel by viewModels{ viewModelFactory }
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney))
    ...
    private fun addMarkerStories(data: List<ListStoryItem>){
        data.forEach { data ->
            val lat = data.lat ?: return@forEach // Skip if lat is null
